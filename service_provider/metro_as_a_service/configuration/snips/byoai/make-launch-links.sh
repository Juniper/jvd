...
# URLs that bootstrap an AI chat with the MaaS BYOAI system prompt.
#
# These URLs ship a short bootstrap message that tells the AI to
# fetch jvd-maas-byoai-prompt.txt from GitHub and adopt it as its
...
PROMPT_URL="https://raw.githubusercontent.com/Juniper/jvd/main/service_provider/metro_as_a_service/configuration/snips/byoai/jvd-maas-byoai-prompt.txt"
