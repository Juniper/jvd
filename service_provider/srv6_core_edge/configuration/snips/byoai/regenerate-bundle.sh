#!/usr/bin/env bash
#
# Regenerate jvd-srv6-snips.md from the current contents of
...
OUT="byoai/jvd-srv6-snips.md"

{
  echo "# JVD SRv6 Core Edge snippet library"
  echo
...
PROMPT_OUT="byoai/jvd-srv6-byoai-prompt.txt"
