#!/usr/bin/env bash
#
# Regenerate jvd-llq-snips.md from the current contents of
...
OUT="byoai/jvd-llq-snips.md"

{
  echo "# JVD Low Latency QoS for 5G (LLQ) snippet library"
  echo
...
PROMPT_OUT="byoai/jvd-llq-byoai-prompt.txt"
