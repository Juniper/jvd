...
# fetch jvd-llq-byoai-prompt.txt from GitHub and adopt it as its
...
PROMPT_URL="https://raw.githubusercontent.com/Juniper/jvd/main/service_provider/low_latency_queueing/configuration/snips/byoai/jvd-llq-byoai-prompt.txt"
