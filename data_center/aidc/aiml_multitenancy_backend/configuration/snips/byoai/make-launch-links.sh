...
# fetch jvd-aiml-mtb-byoai-prompt.txt from GitHub and adopt it as its
...
PROMPT_URL="https://raw.githubusercontent.com/Juniper/jvd/main/data_center/aidc/aiml_multitenancy_backend/configuration/snips/byoai/jvd-aiml-mtb-byoai-prompt.txt"
