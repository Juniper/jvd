#!/usr/bin/env bash
#
# Regenerate jvd-aiml-inf-snips.md from the current contents of
...
OUT="byoai/jvd-aiml-inf-snips.md"

{
  echo "# JVD AI Data Center Frontend Fabric for Inference snippet library"
  echo
...
PROMPT_OUT="byoai/jvd-aiml-inf-byoai-prompt.txt"
