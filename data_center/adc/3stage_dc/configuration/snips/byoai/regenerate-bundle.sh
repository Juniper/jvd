#!/usr/bin/env bash
#
# Regenerate jvd-3stage-dc-snips.md from the current contents of
...
OUT="byoai/jvd-3stage-dc-snips.md"

{
  echo "# JVD 3-Stage Data Center (EVPN-VXLAN) snippet library"
  echo
...
PROMPT_OUT="byoai/jvd-3stage-dc-byoai-prompt.txt"
