...
# fetch jvd-3stage-dc-byoai-prompt.txt from GitHub and adopt it as its
...
PROMPT_URL="https://raw.githubusercontent.com/Juniper/jvd/main/data_center/adc/3stage_dc/configuration/snips/byoai/jvd-3stage-dc-byoai-prompt.txt"
