...
# fetch jvd-collapsed-access-byoai-prompt.txt from GitHub and adopt it as its
...
PROMPT_URL="https://raw.githubusercontent.com/Juniper/jvd/main/data_center/adc/collapsed_dc_fabric_with_access/configuration/snips/byoai/jvd-collapsed-access-byoai-prompt.txt"
