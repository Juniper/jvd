#!/usr/bin/env bash
#
# Regenerate jvd-collapsed-access-snips.md from the current contents of
...
OUT="byoai/jvd-collapsed-access-snips.md"

{
  echo "# JVD Collapsed Data Center Fabric with Access Switches snippet library"
  echo
...
PROMPT_OUT="byoai/jvd-collapsed-access-byoai-prompt.txt"
