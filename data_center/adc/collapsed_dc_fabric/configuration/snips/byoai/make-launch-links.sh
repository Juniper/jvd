...
# fetch jvd-collapsed-byoai-prompt.txt from GitHub and adopt it as its
...
PROMPT_URL="https://raw.githubusercontent.com/Juniper/jvd/main/data_center/adc/collapsed_dc_fabric/configuration/snips/byoai/jvd-collapsed-byoai-prompt.txt"
