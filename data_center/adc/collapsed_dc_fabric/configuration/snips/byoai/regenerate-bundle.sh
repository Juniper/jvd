#!/usr/bin/env bash
#
# Regenerate jvd-collapsed-snips.md from the current contents of
...
OUT="byoai/jvd-collapsed-snips.md"

{
  echo "# JVD Collapsed Data Center Fabric snippet library"
  echo
...
PROMPT_OUT="byoai/jvd-collapsed-byoai-prompt.txt"
