#!/usr/bin/env bash
#
# Regenerate jvd-5stage-snips.md from the current contents of
...
OUT="byoai/jvd-5stage-snips.md"

{
  echo "# JVD 5-Stage EVPN-VXLAN Data Center snippet library"
  echo
...
PROMPT_OUT="byoai/jvd-5stage-byoai-prompt.txt"
