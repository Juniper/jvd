...
# fetch jvd-5stage-byoai-prompt.txt from GitHub and adopt it as its
...
PROMPT_URL="https://raw.githubusercontent.com/Juniper/jvd/main/data_center/adc/5stage_evpn_vxlan/configuration/snips/byoai/jvd-5stage-byoai-prompt.txt"
