#!/usr/bin/env bash
#
# Regenerate jvd-evpn-dci-snips.md from the current contents of
...
OUT="byoai/jvd-evpn-dci-snips.md"

{
  echo "# JVD EVPN-VXLAN Data Center Interconnect (DCI) snippet library"
  echo
...
PROMPT_OUT="byoai/jvd-evpn-dci-byoai-prompt.txt"
