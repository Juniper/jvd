#!/usr/bin/env bash
#
# Regenerate jvd-so-ipsec-snips.md from the current contents of
...
OUT="byoai/jvd-so-ipsec-snips.md"

{
  echo "# JVD Scale-Out IPsec (CSDS ScaleOut) snippet library"
  echo
...
PROMPT_OUT="byoai/jvd-so-ipsec-byoai-prompt.txt"
