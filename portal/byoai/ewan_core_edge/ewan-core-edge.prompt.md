---
description: 'Enterprise WAN: Core/Edge — Juniper Validated Design BYOAI assistant: config generation and design Q&A grounded in the validated snip library.'
name: jvd-ewan-core-edge
agent: agent
tools: ['fetch']
---
