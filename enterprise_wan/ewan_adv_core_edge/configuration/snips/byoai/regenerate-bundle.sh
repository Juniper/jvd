#!/usr/bin/env bash
#
# Regenerate jvd-ewan-ace-snips.md from the current contents of
...
OUT="byoai/jvd-ewan-ace-snips.md"

{
  echo "# JVD EWAN Advanced Core Edge snippet library"
  echo
...
PROMPT_OUT="byoai/jvd-ewan-ace-byoai-prompt.txt"
