#!/usr/bin/env bash
#
# Regenerate jvd-ewan-fin-snips.md from the current contents of
...
OUT="byoai/jvd-ewan-fin-snips.md"

{
  echo "# JVD EWAN Finance snippet library"
  echo
...
PROMPT_OUT="byoai/jvd-ewan-fin-byoai-prompt.txt"
